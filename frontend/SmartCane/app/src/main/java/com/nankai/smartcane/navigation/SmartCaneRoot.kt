    ...
    MaterialTheme(
        ...
        when (route) {
            ...
            AppRoute.BlindHome -> BlindHomeScreen(
                ...
                currentPlannedDirection = uiState.currentPlannedDirection,
                nextPlannedDirection = uiState.nextPlannedDirection,
                distanceToDirectionChangeM = uiState.distanceToDirectionChangeM,
